...
<%'Recoge el querystring del elemento y el índice
...
<html>
	<head>
		<title>Sistema Ivmaker / elcomercioperu.com / Modificar asignación foto a nota</title>
		...
		<script language="javascript">
			function fValidafrmModificaFoto(){
				...
				if (bFlag) {
					bFlag= fValidateTextNumber(document.frmModificaFoto.txtPrioridad, "El campo PRIORIDAD debe ser numérico");
				}
				return bFlag;
			}
		</script>
